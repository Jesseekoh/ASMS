...
CREATE TABLE `announcements` (
  ...
  `info` varchar(1027) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `fees` (
  ...
  `level_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `semister_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  CONSTRAINT `fees_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fees_ibfk_2` FOREIGN KEY (`level_id`) REFERENCES `levels` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fees_ibfk_3` FOREIGN KEY (`semister_id`) REFERENCES `semisters` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fees_bills` (
  `fee_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bill_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `major_bill` (
  `major_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bill_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `major_courses` (
  `major_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `courses_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `majors` (
  `name` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `faculty_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `faculty_id` (`faculty_id`),
  CONSTRAINT `majors_ibfk_1` FOREIGN KEY (`faculty_id`) REFERENCES `faculties` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `other_fees` (
  `fees_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bill_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `profile_pictures` (
  `student_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `img` varchar(1025) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `student_id` (`student_id`),
  CONSTRAINT `profile_pictures_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `results` (
  `level_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `semister_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `course_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `score` int NOT NULL,
  `id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  ...
  CONSTRAINT `results_ibfk_1` FOREIGN KEY (`level_id`) REFERENCES `levels` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `results_ibfk_2` FOREIGN KEY (`semister_id`) REFERENCES `semisters` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `results_ibfk_3` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sessions` VALUES (3,'session:I_yXnWo2nCyCJm8cijcu5QsnNEyVpFYS2J628bin1os',_binary '€•?\0\0\0\0\0\0\0}”(Œ\n_permanent”ˆŒid”Œ$d3a1d128-77f0-47c4-9794-39aafa346f39”u.','2024-03-30 13:40:43'),(4,'session:F0h6ZefV8zf-8Bc31lX8b5WmVYTh2nz9rBrcV6YhHXQ',_binary '€•?\0\0\0\0\0\0\0}”(Œ\n_permanent”ˆŒid”Œ$d3a1d128-77f0-47c4-9794-39aafa346f39”u.','2024-03-29 18:57:08'),(5,'session:lFz7fbpnLM3FF8cH-doczvKBb1eNlIXQldONNiBm-SM',_binary '€•?\0\0\0\0\0\0\0}”(Œ\n_permanent”ˆŒid”Œ$d3a1d128-77f0-47c4-9794-39aafa346f39”u.','2024-03-29 19:01:23'),(6,'session:eyJpZCI6ImQzYTFkMTI4LTc3ZjAtNDdjNC05Nzk0LTM5YWFmYTM0NmYzOSJ9.Zd4IhQ.ubL3GjkKZeGyVa6rzxXOAQd3fPg',_binary '€•?\0\0\0\0\0\0\0}”(Œ\n_permanent”ˆŒid”Œ$0df70ed8-960c-400b-9201-6bd7a3e316c1”u.','2024-03-30 09:32:38'),(7,'session:eyJpZCI6ImQzYTFkMTI4LTc3ZjAtNDdjNC05Nzk0LTM5YWFmYTM0NmYzOSJ9.Zdyl_A.JPrjf9IM4tXvalzpUzCstRYQ35c',_binary '€•?\0\0\0\0\0\0\0}”(Œ\n_permanent”ˆŒid”Œ$0df70ed8-960c-400b-9201-6bd7a3e316c1”u.','2024-03-30 09:15:18'),(8,'session:Zo4jqhiFU-Xlmq4ByG-y7Rug_Umcmlk1jAXMOhroYmY',_binary '€•?\0\0\0\0\0\0\0}”(Œ\n_permanent”ˆŒid”Œ$a6ea8f36-aaec-4c74-941d-a28604853a36”u.','2024-03-29 21:06:02'),(9,'session:eyJpZCI6ImE2ZWE4ZjM2LWFhZWMtNGM3NC05NDFkLWEyODYwNDg1M2EzNiJ9.Zd7-Vw.Ft8FXeuSSa0RAmbvaI0_45W4Sac',_binary '€•?\0\0\0\0\0\0\0}”(Œ\n_permanent”ˆŒid”Œ$d3a1d128-77f0-47c4-9794-39aafa346f39”u.','2024-03-30 10:35:54'),(10,'session:eyJpZCI6ImQzYTFkMTI4LTc3ZjAtNDdjNC05Nzk0LTM5YWFmYTM0NmYzOSJ9.Zd9ApA.Uwatrg1sk3es8ZoshDXxUc3nuxc',_binary '€•?\0\0\0\0\0\0\0}”(Œ\n_permanent”ˆŒid”Œ$1964034f-07d9-4d67-a541-8d21383ccf54”u.','2024-03-30 16:53:20');
...
CREATE TABLE `students` (
  ...
  CONSTRAINT `students_ibfk_1` FOREIGN KEY (`level_id`) REFERENCES `levels` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `students_ibfk_2` FOREIGN KEY (`major_id`) REFERENCES `majors` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `students_ibfk_3` FOREIGN KEY (`state_id`) REFERENCES `states` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `students` VALUES ('Oliver','Queen','6BD7A3E316C1','oliver@gmail.com','Male','827ccb0eea8a706c4c34a16891f84e7b','2edb76ee-a467-43ae-ab28-a8264d8637b2','0d551b3a-bd58-40cd-8f4d-c0f4684145db','27df4456-62d3-4dd5-bcc1-bcdb686c9271','0df70ed8-960c-400b-9201-6bd7a3e316c1','2024-02-28 09:14:14','2024-02-28 09:14:14'),('Mark','Iyaji','D9A4B486443D','markiyaji@gmail.com','Male','49ad23d1ec9fa4bd8d77d02681df5cfa','b7c47cb8-966f-4b2b-8cc9-6f760d20a7ff','1aad51b0-301b-4f8d-bd2f-fe9bd2d34625','f1b972ac-8f2a-478b-b926-40ca47bfa9a4','417bf9b8-b345-4d73-af4d-d9a4b486443d','2024-02-17 17:19:57','2024-02-17 17:19:57'),('Miles','Morales','6756D12BBA72','miles@gmail.com','Male','827ccb0eea8a706c4c34a16891f84e7b','744eef4f-b890-4b4e-8263-12f454449500','0a9e2366-e9a6-41f2-8ad9-6d7f30ff27b0','27df4456-62d3-4dd5-bcc1-bcdb686c9271','a1b6d2fc-a7c0-4cc5-849b-6756d12bba72','2024-02-27 20:49:13','2024-02-27 20:49:13'),('Jesse','Ekoh-ordan','A28604853A36','jesseekoh@gmail.com','Male','827ccb0eea8a706c4c34a16891f84e7b','b7c47cb8-966f-4b2b-8cc9-6f760d20a7ff','14b3d65a-203c-43b4-bb72-18166912c2ac','bf882416-f325-4c0f-86e7-b8d10511aed7','a6ea8f36-aaec-4c74-941d-a28604853a36','2024-02-27 20:36:23','2024-02-27 20:36:23'),('Edward','Odey','39AAFA346F39','edwardodey00@gmail.com','Male','3f45f36f0dc58898eff207d1e3b41ce2','b7c47cb8-966f-4b2b-8cc9-6f760d20a7ff','ef0ea08b-0122-4f82-91f5-cf4f7314e417','f1b972ac-8f2a-478b-b926-40ca47bfa9a4','d3a1d128-77f0-47c4-9794-39aafa346f39','2024-02-15 15:15:38','2024-02-17 18:21:07');
...
CREATE TABLE `students_announcement` (
  `student_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `announcement_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `students_results` (
  `student_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `result_id` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2024-02-28 19:37:26
